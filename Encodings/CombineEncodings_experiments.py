...
if __name__ == "__main__":
    ...
    for labeled_percentage in labeled_percentages:
        arguments.extend([(enc1, enc2, encodings_dict[enc1], encodings_dict[enc2], y.copy(), labeled_percentage, clone(model), results_folder) for enc1, enc2 in combinations(encoding_names, 2)])
